"""
URL configuration for AarTangaay project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="AarTangaay API",
      default_version='v1',
      description="API pour la gestion des vagues de chaleur et notifications",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="contact@aartangaay.local"),
